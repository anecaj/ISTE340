...
// Check If Statement for Browser
var IE8orLess = false;
...
//Section for localStorage, regarding changing of the background color
...
// Section for cookies
// Does the cookie exist in the first place
if(GetCookie('user_id') == null || GetCookie('user_id') == ''){
    ...
    var welcome1 = document.createTextNode('Welcome, ' + getName + '! This is your first time here. Click the start cartoon picker button to find a cartoon!');
...
// User already exists
    ...
    var getcartoon = GetCookie('cartoon');
    ...
    if(getcartoon != 'empty'){
        ...
        var welcome2 = document.createTextNode('Last time, your cartoon choice was: ' + getcartoon);
...
function load(){
    ...
    var text = document.createTextNode('Start Cartoon Picker!'); 
    ...
    var text = document.createTextNode('Change Color Scheme');
    buttonRed.style.backgroundColor = '#cf1d64';
...
function loadSelect(current){
    ...
    // If we are at the end of the chain, show the resulting cartoon choices
...
function doFinish(option){
    // Set the cartoon cookie for your final option
    SetCookie('cartoon', option.text);
    ...
    t = document.createTextNode('Here are some Cartoon suggestions!');
